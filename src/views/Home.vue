		...
		v-row
			v-col(cols='12' md='4')
				v-card.px-2.py-5(flat)
					...
					v-row
						v-col.pa-2(cols='12' md='6' v-for='dealsItem, index in deals' :key='index')
			...
			v-col(cols='12' md='4')
				v-card.px-2.pt-5.pb-8(flat)
					...
					v-card-text.pa-0
						v-row
							v-col.pb-0(cols='12' md='6' v-for='(item, index) in accountList' :key='index')
			...
			v-col(cols='12' md='4')
				v-card.px-2.pt-5.pb-8(flat)
					...
					v-card-text.pa-0
						v-row
							v-col.pb-0(cols='12' md='6' v-for='(item,index) in contact' :key='index')
								v-card.deals-item.px-4.py-0(flat outlined)
									v-list-item.pa-0
